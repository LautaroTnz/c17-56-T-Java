...
import { IconAyuda, IconBookMedical, IconBookReception, IconDoctor, IconInicio, IconReception, RegistroMedico, HistoriaClinica } from "../../assets";
                    ...
                    {!expanded && (
                        <div className="flex flex-col items-start ml-9 gap-y-5 pt-2.5">
                            ...
                            <a href="/registropaciente">
                                <div className="h-10"><img className="h-6 w-6" src={RegistroMedico} alt="Inicio" /></div>
                            </a>
                            <a href="/historiaclinica">
                                <div className="h-10"><img className="h-6 w-6" src={HistoriaClinica} alt="Inicio" /></div>
                            </a>
