...
function DropdownsespecialidadesForm({ especialidades, onChange }) {
  ...
  return (
    <Menu as="div" className="absolute xl:w-[353px] w-[330px] h-[50px] rounded-[5px] xl:mt-[2px] xl:ml-0 ml-[-10px]">
      <div className="xl:w-[353px] w-[320px] h-[45px] rounded-[5px] bg-white">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 max-h-60 overflow-y-auto xl:w-[353px] w-full origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
...
export default DropdownsespecialidadesForm;
